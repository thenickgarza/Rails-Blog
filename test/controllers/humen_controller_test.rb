...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference("Human.count") do
      post humen_url, params: { human: { first_name: @human.first_name, last_name: @human.last_name, user_id: @human.user_id } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { first_name: @human.first_name, last_name: @human.last_name, user_id: @human.user_id } }
